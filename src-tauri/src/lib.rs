...
pub fn specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new().commands(tauri_specta::collect_commands![
        ...
        commands::voleeo_bundle::import_voleeo,
        commands::voleeo_bundle::import_voleeo_preview,
        commands::export::export_summary,
        commands::export::export_preview,
        commands::export::export_workspaces,
        ...
        commands::snapshot::snapshot_save,
        commands::snapshot::snapshot_list_summaries,
        commands::snapshot::snapshot_get,
        commands::snapshot::snapshot_rename,
        commands::snapshot::snapshot_set_pinned,
        commands::snapshot::snapshot_delete,
        commands::snapshot::snapshot_replay,
        commands::snapshot::snapshot_get_latest_replay,
        ...
        commands::environment::system_env_list,
        ...
        commands::git::git_entity_diff,
        commands::git::git_conflict_diff,
